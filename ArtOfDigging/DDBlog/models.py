...
from DDBlog.managers import PublicManager
...
class Category(models.Model):
	...
	def get_absolute_url(self):
	    return ('dd_blog_category_detail', None, {'slug': self.slug})
