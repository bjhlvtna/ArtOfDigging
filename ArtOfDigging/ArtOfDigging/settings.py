...
DATABASES = {
    'default': {
        ...
        'NAME': 'ArtOfDiggingDB',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '#bo(we5=vpc!(&amp;j-)&amp;=e5)-^p_97)$-2f61)6o@z^wbwxcy%hv'
...
ROOT_URLCONF = 'ArtOfDigging.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ArtOfDigging.wsgi.application'
